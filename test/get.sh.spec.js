...
describe('get.sh', () => {
  describe('in theory', () => {
    it('should calculate downloading Alpine release', async function () {
      ...
      assertContains(result, `Downloading v1.0.0 of fpie2-alpine for Alpine from https://github.com/gaggle/fpie2/releases/download/v1.0.0/fpie2-alpine to .`)
    })
    ...
    it('should calculate downloading Mac release', async function () {
      ...
      assertContains(result, `Downloading v1.0.0 of fpie2-macos for Mac from https://github.com/gaggle/fpie2/releases/download/v1.0.0/fpie2-macos to .`)
    })
    ...
    it('should calculate downloading Ubuntu release', async function () {
      ...
      assertContains(result, `Downloading v1.0.0 of fpie2-ubuntu for Ubuntu from https://github.com/gaggle/fpie2/releases/download/v1.0.0/fpie2-ubuntu to .`)
    })
  })
})
